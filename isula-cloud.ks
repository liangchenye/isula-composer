...
selinux --disabled
rootpw --plaintext Huawei123
user --name=euleros --password=Pwd2short
...
#services --enabled=sshd,rsyslog,network
services --enabled=sshd,rsyslog,network
# We use NetworkManager, and Avahi doesn't make much sense in the cloud
services --disabled=avahi-daemon,cloud-init,cloud-init-local,cloud-config,cloud-final
...
part pv.01 --grow
volgroup antos pv.01
logvol / --size=5000 --fstype="xfs" --name=root --vgname=antos

# Equivalent of %include fedora-repo.ks
ostreesetup --osname="euleros-antos-host" --remote="euleros-antos-host" --ref="euleros-antos-host/7/x86_64/standard" --url="http://192.168.130.1:45678" --nogpg
